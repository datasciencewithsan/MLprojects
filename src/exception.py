...
def error_message_detail(error, error_detail:sys):
    ...
    file_name = exc_tb.tb_frame.f_code.co_filename # Google search  "custom exception handling in Python documentation"
...
'''
## Following code can be used to test the above code
